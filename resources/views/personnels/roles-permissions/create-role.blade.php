...
<div class="container mx-auto px-6 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-semibold text-gray-800">Créer un Nouveau Rôle</h1>
    ...
    <form action="{{ route('personnels.roles-permissions.store-role') }}" method="POST" class="max-w-4xl">
        @csrf
